// Action class
class Action {
    constructor(name, actionCost, spellLevel, tags, prerequisites, traditions, cast, cost, range, area, targets, savingThrow, duration, frequency, trigger, requirements, description, criticalSuccess, success, failure, criticalFailure, heightenedLevel, heightenedText) {
        this.name = name;
