// Action class
class Action {
    constructor(name, tags, description, actionCost, cost, requirements, spellLevel, criticalSuccess, success, failure, criticalFailure) {
        this.name = name;
        this.tags = tags;
